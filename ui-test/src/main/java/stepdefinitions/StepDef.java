...
//		Assert.assertTrue(homePage.isBackButtonDisplayed());
    ...
    public void user_click_on_portuguese_language() {
        try {
            ...
            test.log(Status.FAIL, "Unexpected error while clicking on the Portuguese language option: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_verify_home_screens_in_portuguese() {
        try {
            assertEquals(homePage.isHomePageTextDisplayed(), globelConstants.HomePageTextInPortugues, "Home page text does not match");
            assertEquals(homePage.getHomePageDescriptionText(), globelConstants.HomePageDescriptionTextInPortugues, "Home page description text does not match");
            assertEquals(homePage.isListOfIssuersTextDisplayed(), globelConstants.ListOfCredentialTypeOnHomePageInPortugues, "List of issuers text does not match");
            assertEquals(homePage.isListOfIssuersDescriptionTextDisplayed(), globelConstants.ListOfCredentialDescriptionTextInPortugues, "List of issuers description text does not match");
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialType, "List of credential types title does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_arabic_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInArabic, "List of credential types title in Arabic does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Arabic: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Arabic: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_tamil_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInTamil, "List of credential types title in Tamil does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Tamil: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Tamil: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_kannada_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInKannada, "List of credential types title in Kannada does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Kannada: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Kannada: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_hindi_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInHindi, "List of credential types title in Hindi does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Hindi: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Hindi: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_french_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInFrench, "List of credential types title in French does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in French: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in French: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_portuguese_language() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInPortugues, "List of credential types title in Portuguese does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Portuguese: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Portuguese: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_for_sunbird() {
        try {
            System.out.println("Veridonia Insurance Company Text Displayed: " + homePage.isVeridoniaInsuranceCompanyTextDisplayed());
            System.out.println("Credential Types Displayed: " + homePage.isCredentialTypesDisplayed());

            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialType, "List of credential types title for Sunbird does not match");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_arabic_language_for_sunbird() {
        try {
            assertEquals(homePage.isCredentialTypesDisplayed(), globelConstants.ListOfCredentialTypeInArabic, "List of credential types title in Arabic for Sunbird does not match");
            test.log(Status.PASS, "User successfully validated the list of credential types title in Arabic for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Arabic for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Arabic for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_tamil_language_for_sunbird() {
        try {
            ...
            test.log(Status.PASS, "User successfully validated the list of credential types title in Tamil for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Tamil for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Tamil for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_kannada_language_for_sunbird() {
        try {
            ...
            test.log(Status.PASS, "User successfully validated the list of credential types title in Kannada for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Kannada for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Kannada for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_hindi_language_for_sunbird() {
        try {
            ...
            test.log(Status.PASS, "User successfully validated the list of credential types title in Hindi for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Hindi for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Hindi for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_french_language_for_sunbird() {
        try {
            ...
            test.log(Status.PASS, "User successfully validated the list of credential types title in French for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in French for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in French for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_validate_the_list_of_credential_types_title_of_the_page_in_portuguese_language_for_sunbird() {
        try {
            ...
            test.log(Status.PASS, "User successfully validated the list of credential types title in Portuguese for Sunbird");
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            ...
            test.log(Status.FAIL, "Element not found while validating the list of credential types title in Portuguese for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while validating the list of credential types title in Portuguese for Sunbird: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_verify_all_the_languages() {
        try {
            ...
            assertTrue(homePage.verifyLanguagesInLanguageFilter(), "Language verification in the language filter failed");
            ...
            test.log(Status.FAIL, "Element not found while verifying languages in the language filter: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while verifying languages in the language filter: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_verify_the_faq_header_and_its_description() {
    	...
    	try {
            ...
            test.log(Status.FAIL, "Element not found while User verify the FAQ header and its description: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
    ...
    public void user_verify_the_only_one_faq_is_open() throws IOException {
        try {
            ...
            test.log(Status.PASS, "Verified that only one FAQ is open. Up Arrow Displayed: " + isUpArrowDisplayed + ", Count: " + upArrowCount);
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); // Log full stack trace
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot"); // Capture screenshot for debugging
    ...
    public void user_verify_the_footer_on_home_page() {
        try {
            ...
            assertEquals(homePage.getFooterText(), globelConstants.FooterText, "Footer text does not match the expected value");
            test.log(Status.PASS, "User verified that the footer text matches the expected value: " + globelConstants.FooterText);
        } catch (AssertionError e) {
            test.log(Status.FAIL, "Assertion failed: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
    ...
    public void user_verify_that_home_banner_get_started() {
        try {
            assertTrue(homePage.isGetStartedButtonDisplayed(), "Get Started button is not displayed on the home banner");
    ...
    public void user_verify_that_home_features_description1() {
        try {
            assertTrue(homePage.isFeatureDescriptionDisplayed(), "Feature description is not displayed on the home page");
    ...
    public void user_verify_that_home_features_mobile_image() {
        try {
            assertTrue(homePage.isFeatureMobileImageDisplayed(), "Feature mobile image is not displayed on the home page");
    ...
    public void user_verify_that_home_features_desktop_image() {
        try {
            assertTrue(homePage.isFeatureDesktopImageDisplayed(), "Feature desktop image is not displayed on the home page");
    ...
    public void user_verify_that_home_feature_item_image() {
        try {
            assertTrue(homePage.isAccessYourCredentialsImageDisplayed(), "Access Your Credentials image is not displayed");
            test.log(Status.PASS, "User verified that the 'Access Your Credentials' image is displayed");

            assertTrue(homePage.isYourDocumentsDownloadedImageDisplayed(), "Your Documents Downloaded image is not displayed");
            ...
            assertTrue(homePage.isWiderAccessAndCompatibilityImageDisplayed(), "Wider Access and Compatibility image is not displayed");
    ...
    public void user_verify_that_home_feature_item_heading() {
        try {
            assertTrue(homePage.isAccessYourCredentialsTextHeaderDisplayed(), "Access Your Credentials heading is not displayed");
            test.log(Status.PASS, "User verified that the 'Access Your Credentials' heading is displayed");

            assertTrue(homePage.isYourDocumentsDownloadedTextHeaderDisplayed(), "Your Documents Downloaded heading is not displayed");
            ...
            assertTrue(homePage.isWiderAccessAndCompatibilityDisplayed(), "Wider Access and Compatibility heading is not displayed");
    ...
    public void user_verify_that_home_feature_first_item() {
        try {
            ...
            assertTrue(homePage.isDownloadWithConfidenceTextDisplayed(), "Download With Confidence text is not displayed");
            ...
            assertTrue(homePage.isYourCredentialsProtectedTextDisplayed(), "Your Credentials Protected text is not displayed");
            ...
            assertTrue(homePage.isAvailableOnYourFavouriteBrowserTextDisplayed(), "Available on Your Favourite Browser text is not displayed");
    ...
    public void user_verify_that_home_feature_first_feature_description() {
        try {
            assertTrue(homePage.isCredentialsSimplifiedDescriptionTextDisplayed(), "Credentials Simplified description is not displayed");
            test.log(Status.PASS, "User verified that 'Credentials Simplified' description is displayed");

            assertTrue(homePage.isNomorePaperworkDescriptionTextDisplayed(), "No More Paperwork description is not displayed");
            test.log(Status.PASS, "User verified that 'No More Paperwork' description is displayed");

            assertTrue(homePage.isDownloadwithConfidenceDescriptionTextDisplayed(), "Download With Confidence description is not displayed");
            test.log(Status.PASS, "User verified that 'Download With Confidence' description is displayed");

            assertTrue(homePage.isSafeAndSoundDescriptionTextDisplayed(), "Safe and Sound description is not displayed");
            test.log(Status.PASS, "User verified that 'Safe and Sound' description is displayed");

            assertTrue(homePage.isSharewithQRCodeDescriptionTextDisplayed(), "Share With QR Code description is not displayed");
            test.log(Status.PASS, "User verified that 'Share With QR Code' description is displayed");

            assertTrue(homePage.isReadSetShareDescriptionTextDisplayed(), "Read, Set, Share description is not displayed");
            test.log(Status.PASS, "User verified that 'Read, Set, Share' description is displayed");

            assertTrue(homePage.isYourCredentialsProtectedDescriptionTextDisplayed(), "Your Credentials Protected description is not displayed");
            ...
            assertTrue(homePage.isAvailableOnYourFavouriteBrowserDescriptionTextDisplayed(), "Available on Your Favourite Browser description is not displayed");
            test.log(Status.PASS, "User verified that 'Available on Your Favourite Browser' description is displayed");

            assertTrue(homePage.isAlwaysWithinReachDescriptionTextDisplayed(), "Always Within Reach description is not displayed");
    ...
    public void user_click_on_data_share_content_validity() {
        try {
            ...
            test.log(Status.FAIL, "Element not found while clicking 'Data Share Content Validity' button: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
            test.log(Status.FAIL, "Unexpected error while clicking 'Data Share Content Validity' button: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        }
    ...
    public void user_click_on_select_custom_validity_button() {
        try {
            ...
            test.log(Status.FAIL, "Element not found while clicking 'Select Custom Validity' button: " + e.getMessage());
            test.log(Status.FAIL, ExceptionUtils.getStackTrace(e));
            ScreenshotUtil.attachScreenshot(driver, "FailureScreenshot");
            throw e;
        } catch (Exception e) {
    ...
    public void user_verify_home_screen_in_portuguese() {
        try {
            assertEquals(homePage.isHomePageTextDisplayed(), globelConstants.HomePageTextInPortugues, "Home page title text mismatch");
            assertEquals(homePage.getHomePageDescriptionText(), globelConstants.HomePageDescriptionTextInPortugues, "Home page description mismatch");
            assertEquals(homePage.isListOfIssuersTextDisplayed(), globelConstants.ListOfCredentialTypeOnHomePageInPortugues, "List of issuers text mismatch");
            assertEquals(homePage.isListOfIssuersDescriptionTextDisplayed(), globelConstants.ListOfCredentialDescriptionTextInPortugues, "List of issuers description text mismatch");
