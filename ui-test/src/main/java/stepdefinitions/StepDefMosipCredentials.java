...
public class StepDefMosipCredentials {
	...
	public void user_enter_the_otp() {
		try {
			Thread.sleep(3000); // Replace with WebDriverWait ideally
			String email = AdminTestUtil.autoGeneratedIDValueCache.get("AddIdentity_withValidParameters_smoke_Pos_EMAIL");
			System.out.println("Trying to fetch OTP for email: " + email);
