        ...
        >
            <div className="bg-white sm:mx=4 mx-2 rounded-2xl flex flex-col items-center justify-center py-[2%] px-0 sm:px-[18%] relative px-32 pt-32 pb-16">
                ...
                <div className="text-center items-center items-start relative z-20 bg-transparent space-y-4">
                    ...
                    <div className="flex gap-6 items-start w-[85%]">
                        <img
                            src={BackArrowIcon}
                            alt="Back Arrow"
                        ...
                        />
                        <p
                            className="text-iw-textTertiary text-sm sm:text-base font-medium flex items-center justify-center"
                ...
                <div
                    className="flex flex-col bg-white rounded-xl shadow-iw-pinPageContainer mt-8 items-center relative z-20 px-4 sm:px-6 md:px-10 py-3 sm:py-5 md:py-7 space-y-4 w-[50%]"
                ...
                >
                    <div className="bg-iw-paleGray rounded-xl bg-red flex items-start justify-center gap-2 p-4 pr-10">
                        ...
                        <div className="flex flex-col items-left gap-2 sm:gap-4 rounded-lg">
                            <p className="text-xs text-left font-montserrat font-semibold text-black">
                                {t('popupQuestion')}
                            </p>
                            <p className="text-xs text-left font-montserrat font-normal text-black">
                                {t('popupInfo1')}
                            </p>
                            <p className="text-xs text-left font-montserrat font-normal text-black">
                                <Trans
                                    ...
                                    components={{
                                        strong: (
                                            <strong className="text-xs text-left font-montserrat text-black" />
                                        )
                                    }}
                                />
                            </p>
                            <p className="text-xs text-left font-montserrat font-normal text-black">
                                <Trans
                                    ...
                                    ns="ResetWalletPage"
                                    values={{
                                        highlighter: t('popupInfo3.highlighter', {ns: 'ResetWalletPage'})
                                    }}
                                    components={{
                                        strong: (
                                            <strong className="text-xs text-left font-montserrat text-black" />
