export const StoredCardsPageStyles = {
    ...
    headerContainer: "flex flex-col sm:flex-row justify-between ml-2 sm:ml-7 sm:items-center items-start mb-4 sm:mb-6 gap-4 sm:gap-0 px-4 sm:items-start sm:mr-0",
