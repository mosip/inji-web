...
export const ItemBox: React.FC<ItemBoxProps> = (props) => {
    return <React.Fragment>
        <div key={props.index}
             ...
             className={`bg-iw-tileBackground min-w-[250px] w-full h-48 flex flex-col shadow hover:shadow-lg hover:scale-110 hover:shadow-iw-selectedShadow p-5 m-4 rounded-md cursor-pointer items-center`}
            ...
            <div className={"flex justify-center items-center pt-4 overflow-hidden"}>
                <h3 className="flex text-sm font-semibold text-iw-title text-center truncate"
