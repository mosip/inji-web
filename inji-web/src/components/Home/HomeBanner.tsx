...
export const HomeBanner: React.FC<HomeBannerProps> = (props) => {
    ...
    return (
        <div data-testid="HomeBanner-Container" className="py-2 pb-10">
            <div data-testid="HomeBanner-Content" className="mt-8 sm:mx-[8%] md:rounded-xl pt-14 pb-7 sm:py-20 flex flex-col justify-center items-center bg-gradient-to-r from-iw-primary to-iw-secondary h-1/6">
