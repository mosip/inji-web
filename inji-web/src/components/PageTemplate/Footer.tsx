        ...
        >
            <div className="container mx-auto flex flex-col sm:flex-row justify-between items-end sm:items-center">
                <p
                    ...
                    className="ps-7 text-[#9E9E9E] transform rotate-180 text-[12px] leading-[18px] font-medium mr-4"
                >
                    {t("Footer.copyRight")}
                </p>
                <div className={"flex flex-row items-center me-4"}>
                    <p
                        data-testid="Footer-Text"
                        className="transform rotate-180 text-[14px] leading-[22px] font-medium"
                    >
                        {t("Footer.product")}
                    </p>
                    <img
