                ...
                <div className="container mx-auto flex justify-between items-center px-4">
                    <div data-testid="Header-InjiWeb-Logo-Container" className={"flex flex-row space-x-9 justify-center items-center"}>
                        ...
                        <div role="button"
                            ...
                            onKeyUp={() => navigate("/")}>
                            <img src={require("../../assets/Cadastro Ambiental Rural 2.png")}
                        ...
                        <ul className="flex space-x-10 items-center font-semibold" data-testid="Header-Menu-Elements">
                            ...
                            <li data-testid="Header-Menu-Help">
                                <div
                                    ...
                                    role="button"
                                    tabIndex={0}
                                    className="text-iw-title items-center cursor-pointer hidden sm:inline-block"
                                >
                                    {t("Header.help")}
                                </div>
                            </li>
                    ...
                    <div  className={"font-semibold"} data-testid="Header-Menu-LanguageSelector">
                                <LanguageSelector />
                            </div>
                </div>
                {isOpen && (
