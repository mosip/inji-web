...
describe('PasscodePageTemplate Component', () => {
  ...
  test('renders with all elements correctly', () => {
    ...
    expect(screen.getByTestId('passcode-description')).toHaveTextContent(mockSubtitle);
    expect(screen.getByTestId('error-passcode')).toBeInTheDocument();
  ...
  test('renders with back button when onBack is provided', () => {
    ...
    expect(screen.getByTestId('subtitle-reset-passcode')).toHaveTextContent(mockSubtitle);
